/* c33 specific, C compiler specific functions.
...
#endif

static int  pop_data_area          (c33_data_area);
static int  push_data_area         (c33_data_area);
static void mark_current_function_as_interrupt (void);

/* Push a data area onto the stack.  */

static int
push_data_area (c33_data_area data_area)
{
...
static int
pop_data_area (c33_data_area data_area)
{
