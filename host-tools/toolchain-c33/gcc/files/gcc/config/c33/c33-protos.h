/* Prototypes for c33.cc functions used in the md file & elsewhere.
...
/* Function prototypes that cannot exist in c33.h due to dependency
   complications.  */
#ifndef GCC_C33_PROTOS_H
...
extern const char * c33_gen_movdi          (rtx *);
extern rtx    c33_gen_compare              (enum rtx_code, machine_mode,
					     rtx, rtx);
extern machine_mode  c33_select_cc_mode (RTX_CODE, rtx, rtx);
#endif
#endif /* RTX_CODE */

#ifdef TREE_CODE
extern int    c33_interrupt_function_p     (tree);
extern void   c33_output_aligned_bss       (FILE *, tree, const char *, unsigned HOST_WIDE_INT, int);
extern void   c33_output_common            (FILE *, tree, const char *, int, int);
extern void   c33_output_local             (FILE *, tree, const char *, int, int);
extern c33_data_area c33_get_data_area    (tree);
#endif
