...
console_image=$root/linux/artifacts/wr-console
...
if [ ! -f "$console_image" ]; then
	echo "WikiReader console not found at $console_image" >&2
	echo "Run make -C linux console first." >&2
	exit 1
fi
